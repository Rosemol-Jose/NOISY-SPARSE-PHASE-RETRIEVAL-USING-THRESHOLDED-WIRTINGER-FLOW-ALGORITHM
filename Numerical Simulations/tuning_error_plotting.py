# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 09:01:39 2020
...
"""Plotting varying gradient tuning parameter vs error"""
import math
import numpy as np
...
for mu in np.arange(0,1.01,0.01):
...
plt.plot(mu_n, relative_error)
plt.xlabel('gradient tuning parameter') 
